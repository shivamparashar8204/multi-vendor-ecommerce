...
/**
 * Shell shared by every seller dashboard route: sticky top bar, left nav,
 * and a titled content column.
 */
function SellerLayout({ active, title, subtitle, action, children, wide }) {
  return (
    <div className="min-h-screen bg-ink-50">
      ...
      <div className="flex w-full items-start">
        <aside className="w-[80px] shrink-0 width-at-800px">
          <DashboardSidebar activeHeading={active} />
        </aside>
