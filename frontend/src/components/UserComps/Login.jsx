...
function Login() {
  ...
  return (
    <AuthShell
      badge="Welcome back"
      title="Sign in to ShopO"
      subtitle="Pick up where you left off — your cart is waiting."
      highlights={[
        ...
        <div className="flex items-center justify-between">
          ...
          >
            <input
              ...
              name="remember-me"
              id="remember-me"
              className="h-4 w-4 cursor-pointer rounded border-ink-300 text-brand-600 accent-[#4f46e5]"
            />
            Remember me
          </label>
          <a
